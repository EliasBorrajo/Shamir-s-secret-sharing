 ...
 * With this secret key, we can encrypt or decrypt any other file.
 * It can decrypt a file only with the same amount of files it needed to encrypt.
 * The amount of files to encrypt/decrypt has to be bigger than the threshold or equal to it.
 */
package ch.hevs.ui;
