    ...
    private Config()
    {
        ...
        if (storePath == null)
        {
            ...
            JOptionPane.showMessageDialog(null, "No environment variable was found!" +
                    "\nIt is necessary to have an environment variable on the PC named `` SMARTPHONEPROJECT ''" +
            ...
            // @TODO : Remplacer cette erreure GUI par une message dans la CONSOLE
